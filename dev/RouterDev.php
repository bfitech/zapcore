...
class RouterDev extends Router {
	...
	/**
	 * Set test data directory and save its location as a constant.
	 *
	 * Use the directory to put files generated by tests for easier
	 * cleanup and permission setup.
	 */
	final public static function testdir() {
		if (defined('__ZAPTESTDIR__'))
			return __ZAPTESTDIR__;
		define('__ZAPTESTDIR__', dirname(__DIR__) . '/tests/testdata');
